...
class TenthCoverLetter extends StatefulWidget {
  final String code;
  final GetAllCover? cover;
  const TenthCoverLetter({Key? key, required this.code, this.cover}) : super(key: key);

  @override
  // ignore: library_private_types_in_public_api
  _TenthCoverLetterState createState() => _TenthCoverLetterState();
}

class _TenthCoverLetterState extends State<TenthCoverLetter> {
  ...
  String signature = "Anurag kashyap";
                  ...
                  child: Column(
                    children: [
                      ...
                      const Divider(
                        ...
                        indent: 6,
                        endIndent: 10,
                        color: Color.fromARGB(255, 68, 77, 92),
                      ),
                      Container(
