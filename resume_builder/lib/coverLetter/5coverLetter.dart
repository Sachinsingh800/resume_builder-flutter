...
class FifthCoverLetter extends StatefulWidget {
  final String code;
  final GetAllCover? cover;
  const FifthCoverLetter({Key? key, required this.code, this.cover}) : super(key: key);

  @override
  _FifthCoverLetterState createState() => _FifthCoverLetterState();
}

class _FifthCoverLetterState extends State<FifthCoverLetter> {
...
<body>
  <div class="container">
    ...
    <div class="body">
      ...
      <div class="recipient">
        Jane Smith<br>
        CEO, Acme Corporation<br>
        123 Elm Street<br>
        Anytown, CA 12345
      </div>

      <div class="greeting">Dear Ms. Smith,</div>

      <div class="letter-content">
        I am writing to express my strong interest in the [Job Title] position at Acme Corporation, as advertised on LinkedIn. I am excited about the opportunity to contribute my skills and experience to your team.
        ...
        I am highly motivated, detail-oriented, and thrive in fast-paced environments. I look forward to the opportunity to contribute to Acme Corporation's continued growth and success.
      ...
      body: SafeArea(
        top: true,
        child:_isFetching?Center(child: CircularProgressIndicator()):
        SlidingUpPanel(
