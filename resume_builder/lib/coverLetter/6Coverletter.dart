...
class SixthCoverLetter extends StatefulWidget {
  final String code;
  final GetAllCover? cover;
  const SixthCoverLetter({Key? key, required this.code, this.cover}) : super(key: key);

  @override
  // ignore: library_private_types_in_public_api
  _SixthCoverLetterState createState() => _SixthCoverLetterState();
}

class _SixthCoverLetterState extends State<SixthCoverLetter> {
...
<body>
  ...
  <div class="content-container">
    <div class="left-column">
      ...
      <div>
        ${globalController.greeting} ${globalController.rLastName},
      </div>
      <div>
