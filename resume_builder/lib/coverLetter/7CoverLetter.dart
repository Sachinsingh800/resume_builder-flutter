...
class SeventhCoverLetter extends StatefulWidget {
  final String code;
  final GetAllCover? cover;
  const SeventhCoverLetter({Key? key, required this.code, this.cover}) : super(key: key);

  @override
  // ignore: library_private_types_in_public_api
  _SeventhCoverLetterState createState() => _SeventhCoverLetterState();
}

class _SeventhCoverLetterState extends State<SeventhCoverLetter> {
...
<body>
  <div class="container">
    ...
    <div class="contactInfo">
      Phone: ${globalController.phoneNumber}<br>
    ...
    <div class="recipient">
      ${globalController.rFirstName}<br>
      ${globalController.profession}<br>
      ${globalController.companyName}<br>
      ${globalController.rCity} ${globalController.rState}<br>
