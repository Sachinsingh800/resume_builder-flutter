...
class FourthCoverLetter extends StatefulWidget {
  final String code;
  final GetAllCover? cover;
  const FourthCoverLetter({Key? key, required this.code, this.cover}) : super(key: key);

  @override
  _FourthCoverLetterState createState() =>
      _FourthCoverLetterState();
}

class _FourthCoverLetterState extends State<FourthCoverLetter> {
  ...
  <div class="main-container">
    ...
    <div class="content-container">
      ...
      <div class="right-column">
        ...
        <hr class="divider">
        <div class="content-text-bold">
          ${globalController.city}${globalController.state}
        </div>
        <div class="content-text-bold">
