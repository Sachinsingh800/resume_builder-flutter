...
class ThirdCoverLetter extends StatefulWidget {
  final String code;
  final GetAllCover? cover;
  const ThirdCoverLetter({Key? key, required this.code, this.cover}) : super(key: key);

  @override
  _ThirdCoverLetterState createState() => _ThirdCoverLetterState();
}

class _ThirdCoverLetterState extends State<ThirdCoverLetter> {
  ...
  <div class="main-container">
    ...
    <div class="content-container">
      <div class="left-column">
        ...
        <p>${globalController.state}</p>
        <p>${globalController.zip}</p>
        <p>${globalController.date}</p>
        <p>${globalController.rFirstName} ${globalController.rLastName}</p>
        <p>${globalController.profession}</p>
        <p>${globalController.companyName}</p>
        <p>${globalController.rCity}</p>
        <p>${globalController.rZip}</p>
        <p>${globalController.greeting},</p>
        ...
        <hr />
        <p>Sincerely,</p>
        <p class="signature">${globalController.firstName} ${globalController.signature}</p>
      </div>
    </div>
  </div>
</body>
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Padding(
                                ...
                                child: Text(
                                  '${globalController.firstName} ${globalController.signature}',
                                  style: TextStyle(
                                        fontFamily: 'Readex Pro',
                                        color: Colors.black,
                                        fontSize: 16,
