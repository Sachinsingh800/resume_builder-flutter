...
class SixteenResumeTemplate extends StatefulWidget {
  File? image;
   SixteenResumeTemplate({Key? key, this.image}) : super(key: key);

  @override
  _SixteenResumeTemplateState createState() =>
      _SixteenResumeTemplateState();
}

class _SixteenResumeTemplateState
    extends State<SixteenResumeTemplate> {
  // String? imagePath;
              ...
              children: [
                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      Text(
                        'Juris octire (kB), associated 2019',
                        style: TextStyle(
                              fontFamily: 'Readex Pro',
                              fontSize: 10,
                              fontWeight: FontWeight.bold,
